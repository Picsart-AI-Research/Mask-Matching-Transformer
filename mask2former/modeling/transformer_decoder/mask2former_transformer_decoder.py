...
class MultiScaleMaskedTransformerDecoder(nn.Module):
    ...
    def forward(self, x, mask_features, mask = None):
        ...
        que_predictions_mask, que_mask_embeds, decoder_output = self.forward_features(x, mask_features)
    ...
    def forward_features(self, x, mask_features, sup_mask_embeds_best = None):
        ...
        _, outputs_mask, attn_mask, mask_embed, _ = self.forward_prediction_heads(output, mask_features, attn_mask_target_size=size_list[0])
        ...
        for i in range(self.num_layers):
            ...
            _, outputs_mask, attn_mask, mask_embed, decoder_output = self.forward_prediction_heads(output, mask_features, attn_mask_target_size=size_list[(i + 1) % self.num_feature_levels])
            # predictions_class.append(outputs_class)
            predictions_mask.append(outputs_mask)
            mask_embeds.append(mask_embed)
        ...
        return predictions_mask, mask_embeds, decoder_output
    ...
    @torch.jit.unused
    def _set_aux_loss(self,outputs_seg_masks, sup_outputs_seg_masks=None):
